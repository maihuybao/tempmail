        ...
        <div className="max-w-xl mx-auto space-y-8">
          ...
          <div className="rounded-xl border border-accent/30 bg-accent-subtle p-4 sm:p-5 space-y-2">
            ...
            <p className="text-sm text-fg-muted">
              If you own a domain and want it added to {siteName}, contact the
              admin below. We will configure the MX records and set everything
              up for you.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border p-4 sm:p-5 space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <a
                href="https://t.me/Mo_Ho_Bo"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-3 p-3 rounded-lg bg-bg-subtle hover:bg-bg-hover transition-colors"
              >
              ...
              <a
                href="https://t.me/sonnguyenthanh"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-3 p-3 rounded-lg bg-bg-subtle hover:bg-bg-hover transition-colors"
              >
                ...
                <div>
                  <p className="text-xs text-fg-muted mb-0.5">Telegram</p>
                  <p className="text-fg">@sonnguyenthanh</p>
                </div>
              </a>
            </div>
            <p className="text-xs text-fg-muted">
              Please include your domain name and any relevant details in your
              message.
            </p>
          </div>
        </div>
