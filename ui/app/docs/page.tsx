...
const endpoints = [
    ...
    params: [
      {
        ...
        type: "string",
        required: true,
        desc: "Địa chỉ email (vd: user@domain.com)",
      },
    ],
    example: 'curl "https://{{domain}}/api/inbox?email=test@domain.com"',
    response: `{
  "ok": true,
  "count": 2,
  "emails": [
  ...
  },
  {
    ...
    params: [],
    example: 'curl "https://{{domain}}/api/domains"',
    response: `{
  "ok": true,
  ...
  },
  {
    ...
    params: [],
    example: 'curl "https://{{domain}}/api/generate"',
    response: `{
  "ok": true,
      ...
      <div className="flex-1 px-4 sm:px-8 py-8 sm:py-12">
        <div className="max-w-3xl mx-auto space-y-8">
          <div>
            <Link
              href="/"
              className="text-sm text-fg-muted hover:text-fg transition-colors inline-flex items-center gap-1 mb-4"
            >
          ...
          <div className="rounded-xl border border-border bg-bg-subtle p-4 text-sm space-y-1">
            <p className="text-fg-muted text-xs mt-1">
              ...
              <code className="bg-bg-hover px-1 py-0.5 rounded text-xs">
                {"{ ok: boolean, ... }"}
              </code>
            </p>
          </div>
            ...
            >
              <div className="px-4 sm:px-5 py-4 bg-bg-subtle border-b border-border">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="px-2 py-0.5 rounded text-xs font-mono font-bold bg-accent-subtle text-accent">
                    {ep.method}
                  </span>
              ...
              <div className="px-4 sm:px-5 py-4 space-y-4">
                {ep.params.length > 0 && (
                  <div>
                    <p className="text-xs font-medium text-fg-muted mb-2 uppercase tracking-wide">
                      Parameters
                    </p>
                ...
                <div>
                  ...
                  <pre className="bg-bg-subtle rounded-lg p-3 text-xs font-mono overflow-x-auto border border-border">
                    {ep.example}
                  </pre>
                </div>
